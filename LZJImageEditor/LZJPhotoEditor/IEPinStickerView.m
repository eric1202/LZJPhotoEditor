...
@interface IEPinStickerView ()<UIGestureRecognizerDelegate>

@property (nonatomic, strong) UIView *seperatoeView;

@end

@implementation IEPinStickerView

- (void)layoutSubviews
{
    self.seperatoeView.frame = CGRectMake(0, 0, 104, 104);
    ...
    self.contentImageView.frame = CGRectMake(0, 0, 100, 100);
...
- (void)setIsSelected:(BOOL)isSelected
{
    ...
    if (isSelected) {
        self.seperatoeView.layer.borderColor = [UIColor colorWithWhite:1 alpha:0.5].CGColor;
...
- (UIView *)seperatoeView
{
    if (!_seperatoeView) {
        ...
        _seperatoeView.layer.borderColor = [UIColor colorWithWhite:1 alpha:0.5].CGColor;
